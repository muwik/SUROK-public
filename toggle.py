...
from PyQt6.QtCore import Qt, QPoint, QPointF, QRectF, QEasingCurve, QPropertyAnimation, QSequentialAnimationGroup, pyqtSlot, pyqtProperty
...
class AnimatedToggle(QCheckBox):
    ...
    def __init__(self,
        ...
        self.bar_checked_brush = QBrush(QColor('#b29eba'))
